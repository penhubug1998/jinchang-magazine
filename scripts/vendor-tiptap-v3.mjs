...
// This manifest is committed source and must be reproducible. Wall-clock build time belongs
// in release/evidence receipts, not in a source-controlled artifact whose bytes gate Final.
const manifest={version,bytes:bytes.length,sha256,source:'npm packages bundled by esbuild',externalRuntime:false,reproducible:true};
