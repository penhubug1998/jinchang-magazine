...
const mockReplacement='const mock=`<script>window.__V3_APP_BASE_OVERRIDE__="/";window.__V3_FORCE_WORKSPACE__=true;try{history.replaceState=()=>{}}catch{}window.confirm=()=>true;window.__LIVE_PUSH_COUNT__=0;';
