...
for(const f of ['lib-v3-production.mjs','lib-v3-history.mjs','lib-v3-import.mjs','lib-v3-catalog.mjs','lib-v3-publication.mjs','new-issue-v3.mjs','sync-assets-v3.mjs','audit-v3.mjs','studio-v3.mjs','catalog-v3.mjs'])await cp(path.join(root,'scripts',f),path.join(sandbox,'scripts',f));
