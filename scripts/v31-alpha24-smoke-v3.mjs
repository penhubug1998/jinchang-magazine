...
assert(pkg.version==='3.1.0'||/^3\.1\.0-alpha\.(?:2[4-9]|[3-9]\d+)$/.test(pkg.version)||['3.1.0-beta.1','3.1.0-rc.1','3.1.0-rc.2'].includes(pkg.version),`version ${pkg.version}`);assert(pkg.v31SchemaVersion==='3.1-alpha24',`schema ${pkg.v31SchemaVersion}`);assert(pkg.v3StableVersion==='3.0.0','stable version changed');
