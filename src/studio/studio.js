...
function mobileStudioViewportActive(){const force=new URLSearchParams(location.search).get('mobile')==='1';return Boolean(WORKSPACE_MODE&&(force||window.innerWidth<=MOBILE_STUDIO_BREAKPOINT||window.innerHeight<=MOBILE_STUDIO_HEIGHT_BREAKPOINT));}
